...
@section('maincontent')
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <a href="{{ url("table/barang") }}" class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                All Data = {{ $countdatatable["barang"] }}
                            </div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">All Data = {{ $countdatatable["supplier"] }}</div>
                        </div>
                        <div class="col-auto">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                        All Data = {{ $countdatatable["pelanggan"] }}
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                All Data = {{ $countdatatable["pegawai"] }}
                            </div>
                        </div>
                        <div class="col-auto">
